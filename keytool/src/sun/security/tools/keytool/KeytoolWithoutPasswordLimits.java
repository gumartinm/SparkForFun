...
package sun.security.tools.keytool;
        ...
        import static sun.security.tools.keytool.KeytoolWithoutPasswordLimits.Command.*;
        import static sun.security.tools.keytool.KeytoolWithoutPasswordLimits.Option.*;
 ...
 * @since 1.2
 */
public final class KeytoolWithoutPasswordLimits {
    ...
    private KeytoolWithoutPasswordLimits() { }

    public static void main(String[] args) throws Exception {
        KeytoolWithoutPasswordLimits kt = new KeytoolWithoutPasswordLimits();
    ...
    void doCommands(PrintStream out) throws Exception {
        ...
        if (command == GENKEYPAIR && keyPass!=null && keyPass.length < 1) {
        ...
        if (destKeyPass != null && destKeyPass.length < 1) {
            throw new Exception(rb.getString
                    ("New.password.must.be.at.least.6.characters"));
        }
        ...
        if (nullStream && storePass != null) {
            ...
            if (ksStream == null && storePass.length < 1) {
                throw new Exception(rb.getString
            ...
            if (!protectedPath && !KeyStoreUtil.isWindowsKeyStore(storetype) &&
                ...
                do {
                    ...
                    // If we are creating a new non nullStream-based keystore,
                    // insist that the password be at least 6 characters
                    if (!nullStream && (storePass == null || storePass.length < 1)) {
                        System.err.println(rb.getString
