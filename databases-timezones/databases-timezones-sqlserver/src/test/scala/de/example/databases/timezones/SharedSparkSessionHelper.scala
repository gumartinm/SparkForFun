...
trait SharedSparkSessionHelper
  ...
  protected def sparkConf: SparkConf = {
    new SparkConf()
      ...
      .set("spark.sql.session.timeZone", "UTC") // Server working with UTC, databases with Europe/Madrid
      //.set("spark.hadoop.hive.metastore.uris", "thrift://localhost:9083") // Comment this line out for using embedded
      //.set("spark.sql.warehouse.dir", "/apps/spark/warehouse")             // Comment this line out for using embedded
  }
